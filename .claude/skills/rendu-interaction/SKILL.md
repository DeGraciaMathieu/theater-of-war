...
| Marqueurs de bataille | `dessinerBatailles` : lit `etat.batailles` (rempli par `combat()`), halo + cartouche de pertes, progression `b.t` sur ~900 ms |
...
| Boutons | `#bStep`, `#bAuto`, `#bSupply`, `#bReset`, `#bAngers` — câblés dans `interaction.js` |
